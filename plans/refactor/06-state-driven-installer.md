...
- **Steps complete:** 12 / 22 (Steps 1-11 + 14, plus the conflict-bridge follow-up + state-check expansion)
- **Slice complete:** *pending — Session D remaining items are Step 12 (subprocess error absorption) and Step 13 (`--full` repair-mode semantics). Session E covers Steps 15-22 (bug fixes, TTY/no-graphical-session paths, cutover, docs)*
